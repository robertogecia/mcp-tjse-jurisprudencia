...
tente de novo. O nome do arquivo `.tar.gz` muda a cada atualização do projeto; confira o nome
exato clicando em **[Releases](https://github.com/robertogecia/mcp-tjse-jurisprudencia/releases/latest)**
na página do projeto, antes de colar o comando.
